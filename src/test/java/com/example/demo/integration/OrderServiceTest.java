...
public class OrderServiceTest {
    ...
    public void createOrderWitCustomerAndInvalidProduct(){
        String expectedMsn = "Error when Order was created Error de violación de restricción de integridad: Product not found id: 2  ";
        Customer customer1 = new Customer();
        customer1.setId(1);
        customer1.setPhone("12345");
        customer1.setEmail("email@j.co");
        ...
        assertEquals(expectedMsn, exception.getMessage());

    }

    @Test
    public void createOrderWitCustomerWithOutProduct(){
        String expectedMsn = "Error when Order was created Error de violación de restricción de integridad: Products order empty  ";
        Customer customer1 = new Customer();
        customer1.setId(1);
        customer1.setPhone("12345");
        customer1.setEmail("email@j.co");
    ...
    public void createOrderWitCustomerAndProductWithSameOrderCode(){
        String expectedMsn = "Error when creating the Order  Error de violación de integridad de datos: Data integrity violation error: could not execute statement; SQL [n/a]; constraint [null]; nested exception is org.hibernate.exception.ConstraintViolationException: could not execute statement ";
